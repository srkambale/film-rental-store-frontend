    ...
    public void init() {
        ...
        teamMembers.add(new TeamMember("Roshni Bajaj", "Customer Module", "/images/roshni.png", "customer", 
            ...
            Arrays.asList(
                ...
                new EndpointInfo("PUT", "/api/v1/customer/{id}", "Update Profile Basics", "Admin/Customer", "{\"firstName\":\"Alice\",\"lastName\":\"Updated\",\"email\":\"alice.new@example.com\"}"),
                new EndpointInfo("PATCH", "/api/v1/customer/{id}", "Partial Profile Update", "Admin/Customer", "{\"lastName\":\"PartialUpdate\"}"),
                new EndpointInfo("PUT", "/api/v1/customer/{id}/address", "Update Customer Address", "Admin/Customer", "{\"address\":\"456 New St\",\"district\":\"Central\",\"cityId\":1,\"postalCode\":\"12345\",\"phone\":\"555-0199\"}"),
                new EndpointInfo("PATCH", "/api/v1/customer/{id}/address", "Partial Address Update", "Admin/Customer", "{\"phone\":\"555-9999\"}"),
